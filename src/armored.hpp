...
private:
  ...
  vector<IntRect> frames = {
      {10, 69, 13, 24},  {42, 70, 13, 24},   {74, 69, 13, 24},
      {106, 70, 13, 24}, {137, 11, 16, 19},  {137, 43, 16, 19},
      {137, 75, 16, 19}, {137, 108, 16, 19}, {163, 72, 20, 24},
      {163, 41, 21, 20}, {165, 11, 20, 18}};
  vector<IntRect> external_frames = {
