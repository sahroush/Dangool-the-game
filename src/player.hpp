...
static const int IMG_X[] = {23,  55,  87,  120, 151, 183, 215, 248,
                            279, 310, 343, 375, 407, 439, 471, 503,
                            535, 567, 598, 630, 662, 694, 727};
...
static const vector<int> WALK_FRAMES = {0, 1, 2, 3}, JUMP_FRAMES = {4, 5, 6, 7},
                         HIT_FRAMES = {8, 9, 8},
                         SLASH_FRAMES = {11, 10, 11, 12},
                         PUNCH_FRAMES = {11, 13, 11},
                         RUN_FRAMES = {14, 15, 16, 17},
                         CLIMB_FRAMES = {18, 19, 20, 21}, CLIMB_IDLE = {21},
                         IDLE = {0};
